...
def classify_aircraft(model, preprocess):
    ...
    classify(features, zeroshot_weights, labels, "FGVCAircraft")
...
if __name__ == '__main__':
    ...
    aircraft_loaders = aircraft_single_isolated_class_loader()
    classify_aircraft(clip_model, preprocess)
    ...
    for i in tqdm(range(runs)):
        mean, _ = image_decoder(clip_model,
                                ...
                                image_loaders=aircraft_loaders)
