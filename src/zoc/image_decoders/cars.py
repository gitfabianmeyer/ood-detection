...
from zoc.dataloaders.cars_loader import get_cars_loader, cars_single_isolated_class_loader


def classify_cars(model, preprocess):
    loader = get_cars_loader(preprocess)
    ...
    classify(features, zeroshot_weights, labels, "StandfordCars")
...
if __name__ == '__main__':
    ...
    cars_loaders = cars_single_isolated_class_loader()
    # classify_cars(clip_model, preprocess) # fix
